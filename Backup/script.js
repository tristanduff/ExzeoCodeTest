$.getJSON("/albums", { get_param: "value" }, function(data) { //bracket lvl 1, jsonget		//Grabs data from iTunes
...
//code fro grabbing tracks
    	...
    	($.each(data.feed.entry, function(index, element) {	//bracket lvl 2, datafeed														//Array for populating the iTunes data
    		...
    		text:element["im:releaseDate"].attributes.label
				...
				var albumCodePuller = element['id'].attributes;
        var albumCode = albumCodePuller['im:id'];
